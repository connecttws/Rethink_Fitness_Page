    ...
    <section className="relative overflow-hidden bg-[#050505] pt-[72px]">
      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center py-16 md:py-20 lg:py-24 xl:py-32 relative z-10">
        ...
        >
          ...
          <div className="space-y-1">
            <motion.h1
              ...
              className="text-[clamp(2.1rem,6vw,5rem)] font-[900] leading-[0.92] tracking-[-0.03em] text-white whitespace-pre-line"
            >
              {hero.headline.part1}
            </motion.h1>
            <motion.h1
              ...
              className="text-[clamp(2.1rem,6vw,5rem)] font-[900] leading-[0.92] tracking-[-0.03em]"
            >
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-[var(--accent)] text-white font-bold text-sm tracking-[0.08em] px-8 py-4 uppercase transition-all duration-300 hover:-translate-y-0.5 text-center w-full sm:w-auto"
            ...
            <a
              ...
              className="group inline-flex items-center justify-center gap-2 text-white/60 text-sm font-semibold tracking-[0.08em] uppercase hover:text-white transition-colors py-2 text-center w-full sm:w-auto"
            >
          ...
          <motion.div
            ...
            className="flex flex-wrap sm:flex-nowrap gap-6 sm:gap-10 pt-6"
            style={{ borderTop: "1px solid rgba(204,0,0,0.2)" }}
          >
            {hero.stats.map((stat, idx) => (
              <div key={idx}>
                <p className="text-3xl md:text-4xl font-[900] font-[Oswald] tracking-tight leading-none text-white">
                  {stat.value}<span className="text-[#FF3030]">{stat.suffix}</span>
                </p>
        ...
        <motion.div
          ...
          className="relative h-[320px] sm:h-[420px] md:h-[540px] lg:h-[600px] w-full"
        >
          {/* Subtle glow border */}
          <div
          ...
          {/* Glowing corners */}
          <div
            className="absolute top-0 right-0 w-10 h-10 sm:w-16 sm:h-16 border-t-[3px] border-r-[3px]"
            style={{ borderColor: "#CC0000", boxShadow: "3px -3px 14px rgba(204,0,0,0.55), 5px -5px 28px rgba(204,0,0,0.25)" }}
          />
          <div
            className="absolute bottom-0 left-0 w-10 h-10 sm:w-16 sm:h-16 border-b-[3px] border-l-[3px]"
